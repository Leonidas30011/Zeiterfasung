...
def Person_Anlegen():
	...
	# Eingabe Name
	ttk.Label( outer, text = "Name der Person:", style = "CardTitle.TLabel" ).grid( row = 1, column = 0, sticky = "w",
	                                                                            padx = (0, 8), pady = 6 )
	name_var = tk.StringVar()
	entry_name = ttk.Entry( outer, textvariable = name_var )
	entry_name.grid( row = 1, column = 1, sticky = "ew", pady = 6 )
	...
	ttk.Label( outer, text = "Rolle der Person:", style = "CardTitle.TLabel" ).grid( row = 2, column = 0, sticky = "w",
	                                                                                padx = (0, 8), pady = 6 )
	...
	ttk.Label( outer, text = "Einstellungs Art:", style = "CardTitle.TLabel" ).grid( row = 3, column = 0, sticky = "w",
	                                                                                padx = (0, 8), pady = 6 )
...
def Zeit_Nachtraeglich_erfassen( voreinstellung ):
	...
	cb_in_h = ttk.Combobox( time_in_frame, textvariable = in_time_h, values = stunden, width = 5, state = "readonly" )
	cb_in_m = ttk.Combobox( time_in_frame, textvariable = in_time_m, values = minuten, width = 5, state = "readonly" )
	...
	ttk.Label( outer, text = "Bis Datum:", style = "CardTitle.TLabel" ).grid( row = 5, column = 0, sticky = "w",
	                                                                          padx = (0, 8), pady = 6 )
	out_cal = DateEntry( outer, width = 14, background = "darkblue", foreground = "white", date_pattern = "dd.mm.yyyy" )
...
def Ausstempeln():
	...
	ttk.Label( outer, text = "Offene Buchung:", style = "CardTitle.TLabel" ).grid( row = 1, column = 0, sticky = "w",
	                                                                               padx = (0, 8), pady = 6 )
...
zeit_nachtraeglich_erfassen = ttk.Button( top_frame, text = "Zeit Nachträglich erfassen", command = lambda: Zeit_Nachtraeglich_erfassen( "" ) )
